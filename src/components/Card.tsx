...
const Card: React.FC<CardProps> = ({ title, description, status }) => {
  ...
  return (
    <div className={`border-l-8 ${borderColorClass} bg-white rounded-s-lg p-4 shadow-lg w-[70.25rem] h-36 mb-4 md:w-[calc(50% - 2rem)] lg:w-[calc(33.33% - 2rem)] xl:w-[calc(25% - 2rem)]`}>
